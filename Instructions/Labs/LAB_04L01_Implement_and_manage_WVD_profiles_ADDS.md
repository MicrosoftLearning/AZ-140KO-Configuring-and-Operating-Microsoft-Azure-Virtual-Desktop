---
lab:
    title: '랩: Windows Virtual Desktop 프로필 구현 및 관리(AD DS)'
    module: '모듈 4: 사용자 환경 및 앱 관리'
---

# 랩 - Windows Virtual Desktop 프로필 구현 및 관리(AD DS)
# 학생 랩 매뉴얼
...
Active Directory Domain Services(AD DS) 환경에서 Windows Virtual Desktop 프로필 관리를 구현해야 합니다.

## 목표
  
이 랩을 완료하면 다음을 수행할 수 있습니다.

- Windows Virtual Desktop용 FSLogix 기반 프로필 구현
...
#### 작업 1: Windows Virtual Desktop 세션 호스트 VM에서 FSLogix 기반 프로필 구성
...
1. **az140-dc-vm11**에 연결된 원격 데스크톱 세션 내의 **관리자: Windows PowerShell ISE** 스크립트 창에서 다음 명령을 실행하여 두 세션 호스트 VM을 모두 다시 시작합니다.
...
1. **az140-21-p1-0**에 연결된 원격 데스크톱 세션 내의 **관리자: Windows PowerShell ISE** 스크립트 창에서 다음 명령을 실행하여 **az140-21-p1-1** 세션 호스트에서 프로필 레지스트리 설정을 구성합니다.
   ...
   > **참고**: FSLogix 기반 프로필 기능을 테스트하려면 이전 랩에서 사용한 Windows Virtual Desktop 세션 호스트에서 테스트용으로 사용할 **ADATUM\\aduser1** 계정의 로컬에 캐시된 프로필을 제거해야 합니다.
...
#### 작업 2: Windows Virtual Desktop을 사용하여 FSLogix 기반 프로필 테스트
